...
public class Page1 extends AppCompatActivity {
    ...
    private final String LOG_TAG = "Page1";
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(Page1.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    private void callCloudVision(final Bitmap bitmap) throws IOException {
        resultTextView.setText("Come on Bro, the app is retrieving the results from cloud........");
        ...
        new AsyncTask<Object, Void, String>() {
            ...
            protected String doInBackground(Object... params) {
                try {
                    ...
                    //Man, if u don't want the text detection and the landmark detection in the app then comment it out .OK
                    ...
                    // Remember man  due to a bug- requests to Vision API containing large images fail when GZipped.
                ...
                return " Sorry Man the Google Cloud Vision API request failed.";
            }
            protected void getmoreman()
            {
            ...
            {
                Intent l=new Intent(Page1.this,Textitup.class);
                l.putExtra("value",st);
                startActivity(l);
            }
        }.execute();
    ...
    private void getAuthToken() {
        ...
        if (mAccount == null) {
            ...
            new GetTokenTask(Page1.this, mAccount, SCOPE, REQUEST_ACCOUNT_AUTHORIZATION)
                    .execute();
        }
    }
    ...
    public void bcd()
    {
        Intent k=new Intent(this,Textitup.class);
        k.putExtra("label",stlabel);
        startActivity(k);
    }
